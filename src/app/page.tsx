  ...
  if (user) {
    return (
      <div className="flex flex-col">
        ...
        <section className="relative py-12 px-4 sm:px-6 lg:px-8 min-h-screen flex items-center">
          {/* Video Background */}
    ...
    <div className="flex flex-col">
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden min-h-screen flex items-center">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center w-full">
          <h1 className="text-4xl font-bold tracking-tight text-white sm:text-6xl text-shadow-strong">
            Organize seus estudos com
            <span className="text-red-400 block">inteligência</span>
          </h1>
          <p className="mt-6 text-lg leading-8 text-gray-100 max-w-2xl mx-auto text-shadow-medium">
